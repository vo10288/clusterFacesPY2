...
for labelID in labelIDs:
	...
	for i in idxs:
		...
		csv.write(oggi+';'+'ID: '+str(contatore)+' ;'+str(data[i]["imagePath"])+';'+str(md5file1)+';'+str(shafile1)+'\n')
